...
const unfundedDescription = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. ` +
    `${numUnfundedGames === 1 
        ? `There is 1 game that remains unfunded. Please consider supporting it!` 
        : `There are ${numUnfundedGames} games that remain unfunded. Please consider supporting them!`}`;
